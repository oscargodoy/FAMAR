...
## ELEVATION.m: Elevation with respect to LAT [m]
## YEAR: Year
...
## F.date: Date when the shoot was collected from the field (tf)
...
## TurnR: Turnover rate. This is calculated dividing LGR/(SDW*1000) [d-1]
...
###### light and temperature variables
# this information comes from EO data and light at different elevations has been modelled taking into account Kd due to water column (modelling(elevation + tidal sea level). Ask Gloria for further details


## Ed.mean: Daily light dose at surface [mol m-2 d-1] (mean value during the incubation period F.date-0.date)
## Ez.SITE.mean: Daily light dose at the corresponding elevation of the site [mol m-2 d-1] (mean value during the incubation period).
## T.air.mean: Air temperature [ºC]. (mean value during the incubation period)
## T.min: Minimum Air temperature during the period of incubation [ºC]
## T.max: Minimum Air temperature during the period of incubation [ºC]
## Ed.q2: Daily light dose at surface [mol m-2 d-1] (median value during the incubation period)
## Ez.SITE.q2: Daily light dose at the corresponding elevation of the site [mol m-2 d-1] (median value during the incubation period).
## T.air.q2: Air temperature [ºC]. (median value during the incubation period)
